...
namespace MLAgents
{
    ...
    public abstract class Agent : MonoBehaviour
    {
        ...
        {
           // GameObject.Find("DrillbitInScene").GetComponent<SimulationTrajectory>().StopSimulation();
          //  GameObject.Find("FileSystem").GetComponent<DropdownMenuSetup>().runsimsocket();
        }
